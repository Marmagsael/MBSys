# HRMvc — Hybrid MVC + Blazor Server Boilerplate
...
- FluentValidation
- Newtonsoft.Json
- MySQL (via HRApiLibrary)

## Project References
- `HRApiLibrary` — shared data access and models library
...
├── DataAccess/            # Local data access (if any outside HRApiLibrary)
...
5. Register additional scoped services in `StartupConfig/HRMvcScope.cs`
